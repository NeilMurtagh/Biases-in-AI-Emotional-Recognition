...
How_long_is_the_list = 5

integer_list = (range(1,How_long_is_the_list+1))
str_list = [str(x) for x in integer_list]

data = {"1": ["/content/politician ("]*How_long_is_the_list,"2": str_list, "3": [").jpg"]*How_long_is_the_list} # adapt the names of the pictures and the file tpye (png or jpg)
